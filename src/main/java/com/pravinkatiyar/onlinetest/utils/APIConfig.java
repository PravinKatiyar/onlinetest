...
public class APIConfig extends CachingConfigurerSupport {
	...
	public net.sf.ehcache.CacheManager ehCacheManager() {
		...
		CacheConfiguration oneHourCache = new CacheConfiguration();
		oneHourCache.setName("one-hour-cache");
		oneHourCache.setMemoryStoreEvictionPolicy("LRU");
		oneHourCache.setMaxEntriesLocalHeap(1000);
		oneHourCache.setTimeToLiveSeconds(3600);
